...
activities = {
    ...
    "Basketball Club": {
        ...
        "schedule": "Tuesdays, Thursdays, 4:15 PM - 6:00 PM",
        "max_participants": 18,
    ...
    "Math Club": {
        ...
        "max_participants": 20,
        "participants": ["sophia.m@mergington.edu", "william@mergington.edu"]
    }
}
...
def unregister_participant(activity_name: str, email: str):
    ...
    # Validate that the student is actually a participant
